...
public class DarkenDepthsItems {
    ...
    public static final Item DARKSHADOW_CORE  = Registry.registerItems("darkshadow_core", DarkenDepths.MOD_ID,new KnockBackItem(new FabricItemSettings()), DarkenDepthsGroupItems.DARKEN_DEPTHS_GROUP);
